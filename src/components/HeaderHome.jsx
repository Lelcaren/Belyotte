...
const HeaderHome = ({ className = "" }) => {
  return (
    ...
    >
      <div className="w-full max-w-[1440px] mx-auto flex flex-col lg:flex-row items-start justify-between gap-20 mq750:gap-10 mq450:gap-5">
        <div className="w-full lg:w-[768px] flex flex-col items-start justify-start gap-8 mq450:gap-4">
          <div className="mb-2">
          ...
          <div className="flex flex-row items-center gap-6 mt-2 mq750:flex-wrap">
        ...
        <div className="w-full lg:w-auto lg:flex-1 relative min-h-[400px] mq1050:min-h-[350px] mq750:min-h-[300px]">
          <img
            className="w-full h-full min-h-[400px] relative max-w-full overflow-hidden object-cover rounded-lg shadow-lg mq1050:min-h-[350px] mq750:min-h-[300px] mq450:min-h-[250px]"
            loading="lazy"
