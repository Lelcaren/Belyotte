...
const SimpleHome = ({ className = "" }) => {
  return (
    <section
      className={`w-full bg-darkslateblue overflow-hidden flex flex-col items-center justify-start py-28 px-4 box-border gap-20 text-center text-21xl text-color-white font-text-tiny-normal 
        mq1050:px-12
        mq750:gap-10 mq750:py-[73px] mq750:px-8 mq750:box-border 
        mq450:gap-5 mq450:px-4 ${className}`}
    >
      <div className="w-full max-w-[1440px] mx-auto">
        <h1 className="m-0 w-full max-w-[768px] mx-auto relative text-inherit leading-[120%] font-bold font-[inherit] inline-block 
      ...
      <div className="w-full flex flex-col items-start justify-start text-5xl mq750:gap-8 mq450:gap-4">
        <div className="w-full flex flex-row items-stretch justify-center flex-wrap content-start gap-12 mq750:gap-6">
          
          {/* First Card */}
          <div className="flex-1 flex flex-col items-center justify-between gap-8 min-w-[280px] xl:min-w-[320px] mq450:gap-4">
