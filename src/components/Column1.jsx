...
const Column1 = ({ className = "", placeholderImage, heading, text }) => {
  return (
    <div
      className={`flex-1 overflow-hidden flex flex-col items-start justify-start gap-8 text-center text-13xl text-color-scheme-1-text font-text-tiny-normal mq450:gap-4 ${className}`}
    >
      <img
